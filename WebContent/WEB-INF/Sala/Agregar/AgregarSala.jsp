...
<!-- Navigation-->
    ...
    <br>
	<h2>AGREGAR SALA</h2>
	<form class="addSala" action="NuevaSala" method="get" >

	<label for="inputNumeroSala" >Numero Sala</label>
    ...
    <input id="inputCupo" name="cupo" class="form-control" placeholder="cupo" required type="text">
    <br>
